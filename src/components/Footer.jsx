    ...
    return (
        <div className='bg-base-200'>
            ...
            <footer className="footer p-10 text-base-content">
                ...
                <nav>
                    <header className="footer-title">Activities</header>
                    <Link to={'#'} className="link link-hover">Collecting Food</Link>
                    <Link to={'#'} className="link link-hover">Distribute Food</Link>
                    <Link to={'#'} className="link link-hover">Social Campaign</Link>
                    <Link to={'#'} className="link link-hover">Cultural Activities</Link>
                </nav>
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                ...
                <aside className="items-center grid-flow-col">
                    <Link className='flex flex-col items-center'>
                        ...
                        <p className='text-2xl font-bold'>Food Sharing</p>
                    </Link>
                    <p>Sharing surplus food for the community</p>
                    <p>Copyright © 2023 - by Food Sharing</p>
                </aside>
